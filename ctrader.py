...
class Ctrader:
    ...
    def buy(self, symbol, volume, stoploss, takeprofit, price=0):
        ...
        Returns:
            [int]: [order ID]
        """
        return self.trade(symbol,"OPEN",0,"buy",volume,None,None,price,None,None)
            #  self.trade(symbol,action,type,actionType,volume,stoploss,takeprofit,price,deviation)
    ...
    def buyLimit(self, symbol, volume, price=0):
        ...
        Returns:
            [int]: [order ID]
        """
        return self.trade(symbol,"OPEN",2,"buy limit",volume,None,None,price,None,None)
    ...
    def trade(
        ...
        logging.info(
            "Action: %s, Symbol: %s, Lots: %s, Ticket: %s, price: %s, takeprofit: %s, stoploss: %s, type: %s,actiontype: %s",
            v_action,
            v_symbol,
            v_lots,
            v_ticket,
